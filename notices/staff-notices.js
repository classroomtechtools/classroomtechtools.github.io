var adminUserIdList = [2];   // enter IDs as a number, not string

(function() {

    if ( document.location.href.indexOf('mod/data/edit.php') != -1 ) {  // make sure we are on the add entry part
        // dynamically load jquery (or any externally hosted js or css)
        [
            'https://ajax.googleapis.com/ajax/libs/jquery/2.2.0/jquery.min.js',
            'https://classroomtechtools.github.io/jquery.simplyCountable/jquery.simplyCountable.js'
        ...
        if (index === (arr.length-1)) {
            tag.onload = function () {
            // jquery is now loaded at this point, and now we wait for the document to be ready
            $(function () {
